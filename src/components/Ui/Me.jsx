        ...
        <div className='container pt-14'>
          <div className='items-center justify-between md:flex sm:flex-col md:flex-row'>
            <div className='w-full md:basis-1/2'>
              <h5 data-aos='fade-right' data-aos-duration='1500' className='text-headingColor font-[600] text-[16px]'>System.out.println("Hello, World");</h5>
              <h1 data-aos='fade-up' data-aos-duration='1500' className='text-headingColor font-[800] text-[1.8rem] sm:text-[40px] leading-[35px] sm:leading-[46px] mt-5'>I'm Ursu Arsenie<br />Software Developer</h1>
              ...
              <span><i class="ri-apps-line"></i></span><p>I'm a FullStack Web Developer, building project for different people and different needs <a className='text-blue-400' target='_blank' href='https://grades.xsenny.dev'>Grades</a>. In case you got here, check the whole portfolio and see if you might need me.</p></p>
